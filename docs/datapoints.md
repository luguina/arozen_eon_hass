...
| Device ID | ✅ known — recorded once, in [dossier §6.2](research/dossier.md), and deliberately not restated here. One authoritative location per identifier: see [captures/README.md](captures/README.md#redaction-rule) |

### Datapoints

Evidence: [captures/dp-watch-2026-08-21.txt](captures/dp-watch-2026-08-21.txt) (control walk
via the app), [captures/remote-walk-2026-08-21.jsonl](captures/remote-walk-2026-08-21.jsonl)
...
- ~~**What the app's power-off does that a DP 2 write does not.**~~ ✅ **Resolved 2026-08-21
  ...
  explain. Restoring intensity across a power cycle was [#14](https://github.com/luguina/arozen_ha_controller/issues/14), now
  built: a capability the phone app does not have rather than parity with it.
